...
### Released
- Released **secret-rotation-scheduler** publicly as a reviewable operating system for answer-engine visibility.
...
### Shipped
- Cut the first coherent internal version of **secret-rotation-scheduler** with stable domain objects, review surfaces, and decision outputs.
- Established the first reviewable version of the architecture described as: Ops-heavy automation for secret rotation windows, owner prompts, and stale-secret detection across enterprise credential stores. Practical SRE tooling for credential hygiene.
